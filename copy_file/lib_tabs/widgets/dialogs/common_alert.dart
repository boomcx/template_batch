  ...
  Widget _titleWidget() {
    return Padding(
      ...
      child: Column(
        children: [
          if (title.isNotEmpty)
            Text(title, style: myAppColors.text.font_16.bold)
            ...
            RichText(
              ...
              text: TextSpan(
                children: [
                  ...
                  TextSpan(
                      text: content,
                      style: contentStyle ?? myAppColors.text1.font_14),
                ],
              ),
            ).paddingOnly(top: 4),
          ...
          Visibility(
            ...
            child: Padding(
              ...
              child: Text(subContent ?? "", style: myAppColors.text1.font_12),
            ),
          ),
        ],
      ),
              ...
              Expanded(
                child: GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Text(leftTxt,
                        style: leftStyle ?? myAppColors.text1.font_16),
                  ),
                ),
              ),
            ...
            Expanded(
              child: GestureDetector(
                ...
                child: Container(
                  ...
                  height: 42,
                  child: Text(rightTxt,
                      style: rightStyle ?? myAppColors.primary.font_16),
                ),
              ),
            ),
          ],
                  ...
                  children: [
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Text(saveTxt,
                            style: rightStyle ?? myAppColors.text.font_16),
                      ),
                    ),
                    GestureDetector(
                      behavior: HitTestBehavior.translucent,
                      ...
                      child: Container(
                        ...
                        child: Text(cancelTxt,
                            style: leftStyle ?? myAppColors.text.font_16),
                      ),
                    ),
                  ],
                ),
