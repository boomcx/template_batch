...
import 'package:tabs_template/pages/mine/theme_change/controller.dart';

export 'package:tabs_template/pages/mine/theme_change/controller.dart';
export 'package:tabs_template/pages/mine/theme_change/view.dart';
